...
function useAccount(userId) {
    ...
    const [account, setAccount] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(initialAccount);
    ...
    const handleAddTransaction = async (data)=>{
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["runTransaction"])(db, async (transaction)=>{
                ...
                const description = isTransfer ? `Transfer to ${data.recipient}: ${data.description}` : data.description;
...
_s(useAccount, "IIa6gXAK57xg5wrUQD0hhmkam7o=", false, function() {
    return [
...
_s(Home, "0J4gV9sEdkCv7zrszMP3c5aIU30=", false, function() {
    return [
...
//# sourceMappingURL=src_3e55c264._.js.map