...
function useAccount(userId) {
    ...
    const [account, setAccount] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$local$2d$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLocalStorage"])(storageKeyAccount, {
        ...initialAccount,
        id: userId || 'acc_guest'
    });
    const [transactions, setTransactions] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$local$2d$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLocalStorage"])(storageKeyTransactions, initialTransactions.map({
        "useAccount.useLocalStorage": (tx)=>({
                ...tx,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useAccount.useEffect": ()=>{
            if (userId) {
                ...
                if (!userTransactions) {
                    setTransactions(initialTransactions.map({
                        "useAccount.useEffect": (tx)=>({
                                ...tx,
                                accountId: userId
                            })
                    }["useAccount.useEffect"]));
...
_s(useAccount, "e9ak09DrmXUYA/tLjcqz1oykbgY=", false, function() {
    return [
...
function Home() {
    ...
    const { account, transactions, isProcessing, handleAddTransaction } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$account$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAccount"])(user?.uid);
...
_s(Home, "6MW7DzUrHD1Cu2OMKos28msDbq4=", false, function() {
    return [
...
//# sourceMappingURL=src_55262055._.js.map