...
const formSchema = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["object"])({
    ...
    receiptFile: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["any"])().refine((file)=>!file || file[0] && file[0].size <= MAX_FILE_SIZE, `Max file size is 10MB.`).refine((file)=>!file || file[0] && ACCEPTED_IMAGE_TYPES.includes(file[0].type), ".jpg, .jpeg, .png and .webp files are accepted.").optional()
});
...
//# sourceMappingURL=src_1a8a4942._.js.map