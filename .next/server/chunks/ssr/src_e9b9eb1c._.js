...
function useAccount(userId) {
    ...
    const [account, setAccount] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$local$2d$storage$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useLocalStorage"])(storageKeyAccount, {
        ...initialAccount,
        id: userId || 'acc_guest'
    });
    const [transactions, setTransactions] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$local$2d$storage$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useLocalStorage"])(storageKeyTransactions, initialTransactions.map((tx)=>({
            ...tx,
            accountId: userId || 'acc_guest'
        })));
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (userId) {
            ...
            if (!userTransactions) {
                setTransactions(initialTransactions.map((tx)=>({
                        ...tx,
                        accountId: userId
                    })));
            }
...
function Home() {
    ...
    const { account, transactions, isProcessing, handleAddTransaction } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$account$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAccount"])(user?.uid);
...
//# sourceMappingURL=src_e9b9eb1c._.js.map