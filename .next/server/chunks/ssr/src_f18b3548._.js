...
"[project]/src/app/(authed)/my-qr/page.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const formSchema = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["object"])({
    amount: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["coerce"].number().min(0, {
...
function MyQrPage() {
    ...
    const { account, isLoading: isAccountLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$account$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAccount"])(user?.uid);
    ...
    const [qrCodeValue, setQrCodeValue] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('');
    const [requestedAmount, setRequestedAmount] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(undefined);
    ...
    const handleShare = async ()=>{
        if (navigator.share) {
            const shareText = requestedAmount && requestedAmount > 0 ? t('myqr.share.withAmount', {
                amount: Number(requestedAmount).toFixed(2),
                name: account.holderName
            }) : t('myqr.share.withoutAmount', {
                name: account.holderName
            });
            try {
            ...
            toast({
                title: t('myqr.share.notSupportedTitle'),
                description: t('myqr.share.notSupportedDescription')
            });
        }
    };
    const handleSaveQrCode = ()=>{
        if (!qrCodeRef.current || !account) {
            toast({
                variant: "destructive",
                title: t('myqr.save.errorTitle'),
                description: t('myqr.save.errorNotReady')
            });
            return;
        }
        ...
        if (!qrCanvas) {
            toast({
                variant: "destructive",
                title: t('myqr.save.errorTitle'),
                description: t('myqr.save.errorNoCanvas')
            });
            return;
        }
        ...
        if (!ctx) {
            toast({
                variant: "destructive",
                title: t('myqr.save.errorTitle'),
                description: t('myqr.save.errorCreateImage')
            });
            return;
        }
        // Background
        ...
        if (requestedAmount && requestedAmount > 0) {
            ...
            ctx.fillText(t('myqr.scanToPay', {
                name: account.holderName
            }), finalCanvas.width / 2, 450);
        }
        // Footer
        ...
        toast({
            title: t('myqr.save.successTitle'),
            description: t('myqr.save.successDescription')
        });
    };
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Card"], {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CardContent"], {
                    className: "space-y-6",
                    children: [
                        qrCodeValue ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        requestedAmount && requestedAmount > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            className: "text-lg",
                                            children: [
                                                t('myqr.requesting'),
                                                " ",
                                            ...
                                            className: "text-lg",
                                            children: t('myqr.requestingPayment')
                                        }, void 0, false, {
                                            fileName: "[project]/src/app/(authed)/my-qr/page.tsx",
                                            lineNumber: 217,
                                            columnNumber: 29
...
//# sourceMappingURL=src_f18b3548._.js.map